...
const navigationMenuTriggerStyle = cva(
  "  decoration-2 group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors  disabled:pointer-events-none disabled:opacity-50 data-[active]:underline data-[state=open]:underline dark:data-[active]:bg-slate-800/50 dark:data-[state=open]:bg-red-800/50 "
);
