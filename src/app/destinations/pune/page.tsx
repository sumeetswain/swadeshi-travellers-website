...
export default function DestinationPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <PackageLoader title="Backpacking Trips" category="weekend-trips-pune" />
      <PackageLoader title="Weekend Trips" category="backpacking-trips-pune" />
      {/* Packages Section */}
    </div>
  );
}
